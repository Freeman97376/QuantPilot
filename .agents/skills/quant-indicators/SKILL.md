...
```bash
python3 .Codex/skills/quant-indicators/scripts/correlation.py data_file/final/dashboard-data.json -o data_file/final/correlation.json
python3 .Codex/skills/quant-indicators/scripts/liquidity.py data_file/final/dashboard-data.json -o data_file/final/liquidity.json
python3 .Codex/skills/quant-indicators/scripts/trend_template.py data_file/final/dashboard-data.json -o data_file/final/trend-template.json
```
