      ...
      <div className="p-4">
        ...
        {isDragOver && (
          <div className="absolute inset-0 flex flex-col items-center justify-center bg-blue-50 bg-opacity-95 rounded-2xl z-10 pointer-events-none">
            <div className="text-blue-600 text-lg font-medium mb-2">将图片拖到这里</div>
                <div className="text-blue-500 text-base">拖拽图片文件即可上传</div>
            <div className="mt-4">
        ...
        <div className="relative">
          <textarea
            ...
            className="w-full ring-offset-background placeholder:text-slate-500 focus-visible:outline-none focus-visible:ring-0 disabled:cursor-not-allowed disabled:opacity-50 resize-none text-[18px] leading-8 bg-transparent focus:bg-transparent rounded-md px-2 py-2 text-slate-900 border-0"
            id="chatinput"
        ...
        <div className="mt-3 space-y-3 border-t border-slate-100 pt-3">
          <div className="flex min-w-0 items-center gap-2">
            {projectId && (
              (!supportsImageUpload) ? (
                <div
                  className="flex h-9 w-9 shrink-0 items-center justify-center text-slate-300 cursor-not-allowed opacity-50 rounded-full"
                  title={
                    preferredCli === 'qwen'
                ...
                <button
                  type="button"
                  className="flex h-9 w-9 shrink-0 items-center justify-center text-slate-500 hover:text-slate-800 hover:bg-slate-100 rounded-full transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            ...
            <select
              ...
              className="h-10 min-w-0 flex-1 rounded-lg border border-slate-200 bg-white px-3 text-sm font-medium text-slate-700 focus:outline-none focus:ring-2 focus:ring-slate-200 disabled:opacity-60"
              aria-label="选择助手"
            >
          ...
          <div className="flex items-center justify-between gap-3">
            ...
            <Button
              ...
              className="size-10 rounded-full transition-all duration-150 ease-out hover:scale-105 disabled:hover:scale-100"
              disabled={
                isRunning
                  ? isPausing || !onPause
